            ...
            .then(function (playerinfo) {
				...
				.then(async function (recentinfo) {
                    ...
                    const embed = new MessageEmbed()
                        .setColor('#B65FCF')
                        .setAuthor({ name: `Most recent osu!Autopilot play for ${playerinfo.data.player.info.name}`, iconURL: `https://a.mixdev.online/${playerinfo.data.player.info.id}`})
